...
func get_drag_data(_pos):
	...
	if PlayerData.hotbar_data[inv_slot]["Item"] != null:
		
		var data = {}
		data["origin_node"] = self
		data["origin_panel"] = "Hotbar"
		data["origin_item_id"] = PlayerData.hotbar_data[inv_slot]["Item"]
		data["origin_equipment_slot"] = GameData.item_data[str(PlayerData.hotbar_data[inv_slot]["Item"])]["EquipmentSlot"]
		data["origin_stackable"] = GameData.item_data[str(PlayerData.hotbar_data[inv_slot]["Item"])]["Stackable"]
		data["origin_stack"] = PlayerData.hotbar_data[inv_slot]["Stack"]
...
func can_drop_data(_pos, data):
	...
	if PlayerData.hotbar_data[target_inv_slot]["Item"] == null:
		data["target_item_id"] = null
		data["target_texture"] = null
		data["target_stack"] = null
		return true
	else:
		data["target_item_id"] = PlayerData.hotbar_data[target_inv_slot]["Item"]
		data["target_texture"] = texture
		data["target_stack"] = PlayerData.hotbar_data[target_inv_slot]["Stack"]
		data["target_node"] = self
		
		if data["origin_panel"] == "Equipment":
			var target_equipment_slot = GameData.item_data[str(PlayerData.hotbar_data[target_inv_slot]["Item"])]["EquipmentSlot"]
...
func drop_data(_pos,data):
	...
	if data["target_item_id"] == data["origin_item_id"] and data["origin_stackable"] == true and data["origin_panel"] == "Inventory":
	...
	elif data["target_item_id"] == data["origin_item_id"] and data["origin_stackable"] == true and data["origin_panel"] == "Hotbar":
		PlayerData.hotbar_data[origin_slot]["Item"] = null
		PlayerData.hotbar_data[origin_slot]["Stack"] = null
	elif data["origin_panel"] == "Hotbar":
	
		PlayerData.hotbar_data[origin_slot]["Item"] = data["target_item_id"]
		PlayerData.hotbar_data[origin_slot]["Stack"] = data["target_stack"]
		...
		PlayerData.equipment_data["Armor"][origin_slot] = data["target_item_id"]
	...
	if data["target_item_id"] == data["origin_item_id"] and data["origin_stackable"] == true and data["origin_node"] != data["target_node"]:

		var new_stack = data["target_stack"] + data["origin_stack"]

		PlayerData.hotbar_data[target_inv_slot]["Stack"] = new_stack
		data["origin_node"].texture = null
		get_node("../Stack").set_text(str(new_stack))
			
	else:
		
		PlayerData.hotbar_data[target_inv_slot]["Item"] = data["origin_item_id"]
		texture = data["origin_texture"]
		PlayerData.hotbar_data[target_inv_slot]["Stack"] = data["origin_stack"]
